...
class ClientManager
{
    friend class SmartPointer<ClientManager>;
     ...
     */
        SmartPointer<ThreadedTCPConnectedClient> m_client;
    /**
     ...
     */
        ...
        SmartPointer<char> m_myself;
    
        TKeepAliveCounter m_keepAliveCounter;

    private:
    /**
     *  @brief Nullifies moved client manager.
     */
        void
     ...
     */
        explicit ClientManager( const SmartPointer<ThreadedTCPConnectedClient> & client );
     ...
     */
        ClientManager( const ClientManager & copy ) = delete;
    
    /**
     *  @brief Move constructor.
     *
     *  Moves the contents of another client manager. Written to enable usage within stdlib containers.
     *  @param movedObject Client manager to be moved.
     */
        ClientManager( ClientManager && movedObject ) = delete;
     ...
     */
        ...
        void
        Initialize( const SmartPointer<ClientManager> & myself );
    ...
    /**
     *  @brief Move assignment operator, moves the contents to the new client manager.
     *  @param move Instance to be moved from.
     *  @return Returns a reference to itself.
     */
        ClientManager&
        operator = ( ClientManager && move );
