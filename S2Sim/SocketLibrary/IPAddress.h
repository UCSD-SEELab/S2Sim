...
class IPAddress
{
    ...
    /**
     *  Nullifies the content of a moved address.
     */
        void
        NullifyMovedAddress( void );
    ...
    /**
     *  Binary move of the structure.
     
        @param move Address to be copied.
     */
        IPAddress( IPAddress && move );
    ...
    /**
     *  Assignment move operator for binary move.
     *
     *  @param rhs Right hand side of (=).
     *
     *  @return Returns a reference to itself.
