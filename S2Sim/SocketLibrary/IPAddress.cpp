...
void
IPAddress::NullifyMovedAddress( void )
{
...
IPAddress::IPAddress( IPAddress && move )
{
    memcpy( &this->m_address, &move.m_address, sizeof( this->m_address ) );
    move.NullifyMovedAddress();
}
