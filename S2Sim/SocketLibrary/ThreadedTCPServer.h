...
class ThreadedTCPServer : public TCPServer
{
     ...
     */
        typedef SmartPointer<FunctionPointer<SmartPointer<ThreadedTCPConnectedClient>>> TNotification;
     ...
     */
        ...
        ThreadedTCPServer( ThreadedTCPServer && ) = delete;
    
        ThreadedTCPServer&
        operator = ( const ThreadedTCPServer & ) = delete ;
    
        ThreadedTCPServer&
        operator = ( ThreadedTCPServer && ) = delete;
