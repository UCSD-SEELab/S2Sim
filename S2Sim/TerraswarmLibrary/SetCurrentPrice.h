...
namespace TerraSwarm
{
    namespace Synchronous
    {
        ...
        class SetCurrentPrice
        {
             ...
             */
                static SmartPointer<SetCurrentPrice>
        ...
        /**
         *  Set Current Price and Regulation message sent for the Controller to the clients to set the current price, regulation prices and advance the time frame.
         */
        class SetCurrentPriceAndRegulation
        {
            private:
                /**
                 *  Message header values.
            ...
            private:
                 ...
                 *  No use. Private constructor to force usage of the static creation method.
                 */
                SetCurrentPriceAndRegulation( void );
            ...
            public:
                ...
                /**
                 *  Creates a new SetCurrentPriceAndRegulation message and allocates memory for it. @warning Deallocation is the responsibility of the user.
                 *
                 *  @param senderId      Id of the sender.
                 *  @param receiverId    Id of the receiver.
                 *  @param price         Price signal to be set.
                 ...
                 *  @param numberOfPricePoints Number of price points sent within the message.
                 *  @param pricePoints   Price points sent to the client.
                 *  @param upRegulationPricePoints Hypothetical price value for a 10% higher consumption.
                 *  @param downRegulationPricePoints Hypothetical price value for a 10% lower consumption.
                 *
                 *  @return Returns a new allocated message.
                 */
                static SmartPointer<SetCurrentPriceAndRegulation>
                GetNewSetCurrentPriceAndRegulation( const MessageHeader::TSenderId senderId,
                                                    const MessageHeader::TReceiverId receiverId,
                                                    const TInterval intervalBegin,
                                                    const TNumberOfPricePoints numberOfPricePoints,
                                                    TPrice* pricePoints,
                ...
                /**
                 *  Reads the price from the current message.
                 *
                 *  @return Price value in the message.
                 */
                SmartPointer<TPrice>
                ...
                /**
                 *  Reads the up regulation price from the current message.
                 *
                 *  @return Price value in the message.
                 */
                SmartPointer<TPrice>
                GetUpRegulationPrice( void ) const;
                
                /**
                 *  Reads the down regulation price from the current message.
                 *
                 *  @return Price value in the message.
                 */
                SmartPointer<TPrice>
                GetDownRegulationPrice( void ) const;
